...
#include "DrivingSimulatorPlayerController.generated.h"

class UInputMappingContext;
class ADrivingSimulatorPawn;
class UDrivingSimulatorUI;
 ...
 */
UCLASS(abstract)
class DRIVINGSIMULATOR_API ADrivingSimulatorPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<ADrivingSimulatorPawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = UI)
	TSubclassOf<UDrivingSimulatorUI> VehicleUIClass;

	/** Pointer to the UI widget */
	TObjectPtr<UDrivingSimulatorUI> VehicleUI;
