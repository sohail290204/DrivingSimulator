...
#include "DrivingSimulatorOffroadCar.h"
#include "DrivingSimulatorOffroadWheelFront.h"
#include "DrivingSimulatorOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

ADrivingSimulatorOffroadCar::ADrivingSimulatorOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UDrivingSimulatorOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UDrivingSimulatorOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UDrivingSimulatorOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UDrivingSimulatorOffroadWheelRear::StaticClass();
