...
#include "DrivingSimulatorSportsCar.h"
#include "DrivingSimulatorSportsWheelFront.h"
#include "DrivingSimulatorSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ADrivingSimulatorSportsCar::ADrivingSimulatorSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UDrivingSimulatorSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UDrivingSimulatorSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UDrivingSimulatorSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UDrivingSimulatorSportsWheelRear::StaticClass();
